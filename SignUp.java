...
public class SignUp extends JFrame implements ActionListener
{
    ...
    SignUp()
    {
        ...
        final JLabel meterNo = new JLabel("Meter Number");
        ...
        final JLabel Employer = new JLabel("Employer ID");
        ...
        ImageIcon boyIcon = new ImageIcon(ClassLoader.getSystemResource("ElectricitySystem/Character.png"));
